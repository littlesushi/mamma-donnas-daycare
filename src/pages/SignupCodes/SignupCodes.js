...
export default function SignupCodes() {
  ...
  return (
    <div>
      <h2 className="signup-code-header">Customer Signup Code:</h2>
      <p>Current code: {currCustomerCode}</p>
      <form class="signup-code-form" id="change-customer-code-form">
        <input
      ...
      <h2 className="signup-code-header">Admin Signup Code:</h2>
      <p>Current code: {currAdminCode}</p>

      <form class="signup-code-form" id="change-admin-code-form">
        <input
          className="signup-code-input"
          type="text"
          placeholder="Enter a new code"
